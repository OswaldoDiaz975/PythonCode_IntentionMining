...
cursor.execute("SELECT DISTINCT strategy_name, ROUND(weight,2) FROM strategy_weight WHERE weight > 0.3 ORDER BY ROUND(weight,2) DESC")
...
sql = """INSERT INTO user_strategies(strategy_name, ponderation) VALUES(%s,%s)"""
